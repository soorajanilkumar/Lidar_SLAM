...
addpath('runData')
testnum = 1;        %to be set accordingly to the test data
useScan_noisy = false; % true if you want to use noisy scans, false for ideal scans
if useScan_noisy
...
scanStep        = 1;  % to read only 1 in scanStep scans for SLAM after the first 10 scans.
